...
### 🚀 AI Research & Professional Focus
- 🧠 **Graph Machine Learning:** Developing anomaly prediction models for IT infrastructure using node embeddings (Node2Vec) and graph-based representations.
- ⚖️ **Causal Inference:** Enhancing model robustness and interpretability in complex distributed environments.
- 📡 **Network Optimization:** Optimizing Quality of Experience (QoE) for video streaming (DASH) and mobile networks.
- 📊 **Large Scale Data:** Architecting AI solutions for global-scale telecommunications data.

---

### 🛠 Tech Stack & Tools
- **Languages:** Python (Expert), C++, SQL, Bash.
- **AI/ML:** PyTorch, TensorFlow, Scikit-learn, NetworkX, DGL, CausalDiscovery.
- **Tools:** Git, Docker, Kubernetes, Spark, AWS/GCP.
- **Research:** Academic writing, Experimental Design, Performance Benchmarking.

---

### 🎓 Academic Background
- **Ph.D. in Computer Science** – University of Missouri-Kansas City (UMKC)
  - *Focus:* Smart caching, video streaming quality, and in-network prefetching.
